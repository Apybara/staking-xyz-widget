...
export const useCosmosTxProcedures = ({
  ...
  const cosmosTx = broadcastTxMap[type]({
    client: client || null,
    network: network && isCosmosNetwork ? network : undefined,
    address: address || undefined,
    amount,
...
export const useCosmosBroadcastUndelegate = ({
  client,
  amount,
  network,
  address,
...
export const useCosmosWithdrawRewardsProcedures = ({
  ...
  withdrawRewardsStep: CosmosTxStep;
}) => {
  const isCosmosNetwork = getIsCosmosNetwork(network || "");
...
const broadcastTxMap: Record<TxProcedureType, (params: CosmosTxParams & CosmosTxStep) => any> = {
  delegate: useCosmosBroadcastDelegateTx,
  undelegate: useCosmosBroadcastUndelegate,
  redelegate: useCosmosBroadcastRedelegateTx,
};
