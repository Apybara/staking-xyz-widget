...
import { useRedelegating } from "@/app/_contexts/RedelegatingContextV2";
...
export const ClientSideRedelegatePage = ({ searchParams }: { searchParams: RouterStruct["searchParams"] }) => {
  ...
  const redelegatinData = useRedelegating();
  ...
  return (
    <RedelegatingProvider>
      ...
      <TxProcedureDialog
        amount={redelegationAmount}
        data={redelegatinData}
        type="redelegate"
        dialog="redelegatingProcedure"
      />
    </RedelegatingProvider>
  );
};
